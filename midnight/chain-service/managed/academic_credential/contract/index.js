...
class _DisclosedClaim_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment())));
  }
  fromValue(value_0) {
    return {
      institutionId: _descriptor_0.fromValue(value_0),
      degreeCode: _descriptor_2.fromValue(value_0),
      graduationYear: _descriptor_3.fromValue(value_0),
      gpaTimes100: _descriptor_3.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.institutionId).concat(_descriptor_2.toValue(value_0.degreeCode).concat(_descriptor_3.toValue(value_0.graduationYear).concat(_descriptor_3.toValue(value_0.gpaTimes100))));
  }
}

const _descriptor_4 = new _DisclosedClaim_0();

class _CredentialData_0 {
  alignment() {
    return _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_2.alignment().concat(_descriptor_3.alignment().concat(_descriptor_3.alignment())))));
  }
  fromValue(value_0) {
    return {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.studentId).concat(_descriptor_0.toValue(value_0.issuerPk).concat(_descriptor_0.toValue(value_0.institutionId).concat(_descriptor_2.toValue(value_0.degreeCode).concat(_descriptor_3.toValue(value_0.graduationYear).concat(_descriptor_3.toValue(value_0.gpaTimes100))))));
  }
}

const _descriptor_5 = new _CredentialData_0();
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.credentialFields) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named credentialFields');
    }
  ...
  async _issue_0(context, partialProofData, credentialId_0) {
    ...
    __compactRuntime.assert(this._equal_1(fields_0.issuerPk, pk_0),
                            'issuer key mismatch');
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                                 ...
                                                                                                 path: [
                                                                                                        { tag: 'value',
                                                                                                          value: { value: _descriptor_11.toValue(1n),
                                                                                                                   alignment: _descriptor_11.alignment() } }] } },
                                                                                        { push: { storage: false,
                                                                                                  value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(credentialId_0),
                                                                                                                                               alignment: _descriptor_0.alignment() }).encode() } },
                                                                                        'member',
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                           ...
                           revealGpa_0)
  {
    ...
    __compactRuntime.assert(!_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                            ...
                            'credential revoked');
    let tmp_0;
    __compactRuntime.assert((tmp_0 = fields_0.issuerPk,
                             _descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       ...
                                                                                       [
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value)),
                            'issuer not authorized');
    return { institutionId: fields_0.institutionId,
             degreeCode: fields_0.degreeCode,
             graduationYear: fields_0.graduationYear,
             gpaTimes100: revealGpa_0 ? fields_0.gpaTimes100 : 0n };
  }
  _equal_0(x0, y0) {
...
const _dummyContract = new Contract({
  ...
  credentialFields: (...args) => undefined,
